...
//===== That using bracket notation is helpful, along with a for each loop

// Were you able to find useful methods to help you with this?
//===== Unfortunatly no, In the refactor I just removed brackets that weren't necessary.
//===== Though, it isn't better, just different.  

// What concepts were solidified in the process of working through this challenge?
//===== Accessing properties using strings and bracket notation. As well as how to
//===== use the same property name to access similar properties in different objects.
